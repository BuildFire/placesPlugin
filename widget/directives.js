                ...
                link: function (scope, elem, attrs) {
                    ...
                    scope.$watch('locationData', function (newValue, oldValue) {
                        if (newValue) {
                            ...
                            var currentLocationIconImageUrl =window.location.hostname+ '/app/media/google_marker_blue_icon.png';
                            ...
                            var placeLocationIconImageUrl = window.location.hostname+ '/app/media/google_marker_red_icon.png';
                            ...
                            var selectedLocationIconImageUrl = window.location.hostname+ '/app/media/google_marker_green_icon.png';
